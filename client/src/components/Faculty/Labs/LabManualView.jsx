...
3. Verify the output matches expected result`;
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-card rounded-2xl border border-theme-light shadow-2xl w-[92vw] max-w-5xl h-[85vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-theme-light flex-shrink-0">
          <div>
        ...
        <div className="flex flex-1 min-h-0">
          {/* Lab Manual */}
          <div className="w-1/2 border-r border-theme-light flex flex-col">
            <div className="px-5 py-3 border-b border-slate-50 bg-alt/50">
              <span className="text-[11px] font-extrabold text-body uppercase tracking-widest">
                Lab Manual
              </span>
            </div>
            <div className="flex-1 overflow-auto p-5">
              <pre className="whitespace-pre-wrap text-xs text-body bg-alt border border-theme-light rounded-xl p-4 leading-relaxed font-mono">
                {labManual}
              </pre>
            </div>
          </div>
