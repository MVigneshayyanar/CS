      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 md:pt-8 pb-10 sm:pb-12">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-extrabold text-slate-900 leading-tight">Super Admin Settings</h1>
          ...
          <div className="w-full xl:w-56 flex-shrink-0 flex flex-col gap-4 xl:sticky xl:top-8">
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
              ...
              <div className="px-5 pb-5 text-center">
                ...
                <p className="text-[10.5px] text-slate-400 mt-0.5">College Governance</p>
