...
const SuperAdminSettings = () => {
  ...
  useEffect(() => {
    try {
      const saved = localStorage.getItem('super_admin_settings_preferences');
      if (saved) {
        setPreferences((prev) => ({ ...prev, ...JSON.parse(saved) }));
      }
    } catch (error) {
      console.error('Failed to load super admin settings', error);
    }
  }, []);
  ...
  const handleSave = async () => {
    ...
    try {
      localStorage.setItem('super_admin_settings_preferences', JSON.stringify(preferences));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 md:pt-8 pb-10 sm:pb-12">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-extrabold text-heading leading-tight">Super Admin Settings</h1>
          ...
          <div className="w-full xl:w-56 flex-shrink-0 flex flex-col gap-4 xl:sticky xl:top-8">
            <div className="bg-card rounded-2xl border border-theme-light shadow-sm overflow-hidden">
              ...
              <div className="px-5 pb-5 text-center">
                ...
                <p className="text-[10.5px] text-muted mt-0.5">College Governance</p>
                            ...
                            {[1, 2, 3, 4].map((i) => (
                              <div
                                ...
                                className={`h-1 flex-1 rounded-full transition-all ${
                                  i <= pwStrength ? strengthColors[pwStrength] : 'bg-alt'
                                }`}
                              />
                            ))}
                          </div>
