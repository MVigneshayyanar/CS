            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
              ...
              <div className="px-5 pb-5 text-center">
                <div className="relative inline-block -mt-7 mb-2.5">
                  <div
                    className="w-14 h-14 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-700 border-3 border-white flex items-center justify-center text-white text-lg font-extrabold shadow-lg"
              ...
              <SectionCard icon={Lock} title="Update Your Password">
                <form onSubmit={handlePasswordChange} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white text-xs font-extrabold rounded-xl hover:bg-indigo-700 disabled:opacity-50 transition-all shadow-sm shadow-indigo-200"
                  >
